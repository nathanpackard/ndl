...
```text
3x3 kernel  -- spatial convolve():   2.338637 ms/call
3x3 kernel  -- FFT correlation:   5.383107 ms/call
5x5 kernel -- spatial convolve():   6.236625 ms/call
5x5 kernel -- FFT correlation:   5.429718 ms/call
```
