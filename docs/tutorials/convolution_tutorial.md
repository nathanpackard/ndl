...
```text
3x3 kernel  -- spatial convolve():   2.095455 ms/call
3x3 kernel  -- FFT correlation:   4.765575 ms/call
5x5 kernel -- spatial convolve():   5.924559 ms/call
5x5 kernel -- FFT correlation:   4.848484 ms/call
```
